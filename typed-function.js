...
Param.compare = function(a, b, typed) {
  ...
  if (Object(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* contains */])(a.types, 'Object')) return 1;
  if (Object(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* contains */])(b.types, 'Object')) return -1;
...
Param.prototype.overlapping = function(other) {
  for (var i = 0; i < this.types.length; i++) {
    if (Object(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* contains */])(other.types, this.types[i])) {
      return true;
    }
  }
  return false;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = Refs;
/**
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = Signature;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__param__ = __webpack_require__(1);
...
function Signature(params, fn) {
  ...
  for (var i = 0; i < _params.length; i++) {
    var param = new __WEBPACK_IMPORTED_MODULE_0__param__["a" /* Param */](_params[i]);
    this.params[i] = param;
    if (param.anyType) {
      this.anyType = true;
    }
    ...
    if (path.length < signature.params.length) {
      ...
      if (param.varArgs) {
        ...
        for (i = 0; i < typed.conversions.length; i++) {
          ...
          if (
            !Object(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* contains */])(param.types, conversion.from) &&
            Object(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* contains */])(param.types, conversion.to)
          ) {
        ...
        for (i = 0; i < param.types.length; i++) {
          recurse(signature, path.concat(new __WEBPACK_IMPORTED_MODULE_0__param__["a" /* Param */](param.types[i])));
        }
        ...
        for (i = 0; i < typed.conversions.length; i++) {
          ...
          if (
            ...
            newParam = new __WEBPACK_IMPORTED_MODULE_0__param__["a" /* Param */](conversion.from);
...
Signature.compare = function(a, b, typed) {
  ...
  for (i = 0; i < a.params.length; i++) {
    var cmp = __WEBPACK_IMPORTED_MODULE_0__param__["a" /* Param */].compare(a.params[i], b.params[i], typed);
    if (cmp !== 0) {
      return cmp;
    }
  }
